...
<head>
  ...
  <?php
    $meta = [
      'title' => 'Tutorials & How-Tos | The Blog Ship',
      'description' => 'Step-by-step guides for server setup, routing configuration, and system administration.',
      'keywords' => 'Tutorials, How-To, Guides, Server Setup, Routing',
      'active_page' => 'categories/tutorials.php'
    ];
    ...
    <div class="bl-wrap">
      <div class="bl-shell">
        ...
        <header class="bl-head">
          ...
          <h1 class="bl-title">Tutorials & How-Tos</h1>
          <p class="bl-subtitle">Step-by-step guides for server setup, routing configuration, and system administration.</p>
        </header>
